        ...
        Get-ChildItem -Path $sourcePath -Recurse -File | Where-Object {
            ...
            if ($convertFiles) {
                ...
                function CleanUp-OfficeProcesses {
                    $officeProcesses = Get-Process | Where-Object { $_.Name -match "WinWord|EXCEL|POWERPNT" }
                ...
                '.ppt' {
                    if ($convertFiles){
                        ...
                        try {
                            ...
                            $presentation.SaveAs($newPptxFile, 12)  # 12 corresponds to the PowerPoint .pptx format
                            $presentation.Close()                 
                        }
                        catch {
                            $logTextBox.Invoke([Action]{
